...
public class WeiboOAuth2 {
    ...
    public static String URL_OAUTH2_CALL_BACK="https://api.weibo.com/oauth2/default.html";
    
    public static String APP_KEY = "2509592324";
    public static String APP_SECRET = "3055e969f0514406ec396204d14e133e";
   	
    private static WeiboOAuth2 mWeiboInstance = null;
    ...
    public synchronized static WeiboOAuth2 getInstance() {
        if (mWeiboInstance == null) {
            mWeiboInstance = new WeiboOAuth2();
        }
    ...
    public RequestToken getRequestToken(Context context, String key, String secret,
        ...
        String rlt;
        rlt = Utility.openUrl(context, WeiboOAuth2.URL_OAUTH_TOKEN, "POST", postParams, null);
    ...
    public AccessToken generateAccessToken(Context context, RequestToken requestToken)
        ...
        authParam.add("source",  Weibo.CONSUMER_KEY);
        String rlt = Utility.openUrl(context, WeiboOAuth2.URL_ACCESS_TOKEN, "POST", authParam,
                this.mRequestToken);
    ...
    public AccessToken getXauthAccessToken(Context context, String app_key, String app_secret,
        ...
        postParams.add("oauth_consumer_key", Weibo.CONSUMER_KEY);
        String rlt = Utility.openUrl(context, WeiboOAuth2.URL_ACCESS_TOKEN, "POST", postParams, null);
        AccessToken accessToken = new AccessToken(rlt);
        this.mAccessToken = accessToken;
        return accessToken;
    }
    ...
    public Oauth2AccessToken getOauth2AccessToken(Context context, String app_key,
        ...
        String rlt = Utility.openUrl(context, WeiboOAuth2.URL_OAUTH2_ACCESS_TOKEN, "POST", postParams,
                null);
    ...
    private void authorize(Activity activity, String[] permissions, int activityCode,
        ...
        if (activityCode >= 0) {
            singleSignOnStarted = startSingleSignOn(activity,  Weibo.CONSUMER_KEY, permissions, activityCode);
        }
    ...
    public void dialog(Context context, WeiboParameters parameters,
            final WeiboDialogListener listener) {
        parameters.add("client_id",  Weibo.CONSUMER_KEY);
