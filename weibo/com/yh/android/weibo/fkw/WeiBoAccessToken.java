package com.yh.android.weibo.fkw;
 ...
 */
public class WeiBoAccessToken implements java.io.Serializable {
	...
	/*package*/public WeiBoAccessToken(JSONObject json) throws JSONException {
		super();
		init(json);
	}
