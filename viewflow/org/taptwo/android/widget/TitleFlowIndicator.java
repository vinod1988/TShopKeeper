...
public class TitleFlowIndicator extends TextView implements FlowIndicator {
	...
	public TitleFlowIndicator(Context context, AttributeSet attrs) {
		...
		int textColor = a.getColor(R.styleable.TitleFlowIndicator_titleFlowTextColor, TEXT_COLOR);
		float textSize = a.getDimension(R.styleable.TitleFlowIndicator_titleFlowTextSize, TEXT_SIZE);
