 ...
 * com.yh.android.framework.web.client.RestTemplate#setInterceptors(java.util.List) registered} with the
 * {@link com.yh.android.framework.web.client.RestTemplate RestTemplate}, as to modify the outgoing {@link ClientHttpRequest}
...
public interface ClientHttpRequestInterceptor {
	 ...
	 * <li>Optionally {@linkplain com.yh.android.framework.http.client.support.HttpRequestWrapper wrap} the request to filter HTTP attributes.</li>
	 * <li>Optionally modify the body of the request.</li>
	 * <li><strong>Either</strong>
	 * <ul>
	 * <li>execute the request using {@link ClientHttpRequestExecution#execute(com.yh.android.framework.http.HttpRequest, byte[])},</li>
	 * <strong>or</strong>
