...
public class Utility {
    ...
    public static boolean isBundleEmpty(TaoBaoParameter bundle) {
    ...
    public static String encodeUrl(TaoBaoParameter parameters) {
        if (parameters == null) {
            return "";
        }
     ...
     */
    public static UrlEncodedFormEntity getPostParamters(Bundle bundle) throws TaoBaoException {
...
//    public static String openUrl(final String url,final MultiValueMap<String, String> message){
...
//    }
//    
//    public static String openUrl(final String url,TaoBaoParameter params){
//   	 // Create a new RestTemplate instance
//       RestTemplate restTemplate = new RestTemplate(true);
//
//       // Make the network request, posting the message, expecting a String in response from the server
//     
//       ResponseEntity<String> response = restTemplate.getForEntity(url+"?"+encodeUrl(params), String.class);
//
//       // Return the response body to display to the user
//       return response.getBody();
//   }
//   
    ...
    public static String openUrl(Context context, String url, String method,
    		TaoBaoParameter params, String file) throws TaoBaoException {
        String result = "";
        try {
            ...
            if (statusCode != 200) {
				...
				throw new TaoBaoException(String.format(err), errCode);
            }
     ...
     * @return void
     */
    private static void paramToUpload(OutputStream baos, TaoBaoParameter params)
            throws TaoBaoException {
        String key = "";
     ...
     */
    private static String read(HttpResponse response) throws TaoBaoException {
        String result = "";
    ...
    public static String encodeParameters(TaoBaoParameter httpParams) {
