...
public class TestActivity extends Activity {
    TextView mResult;
    WeiboOAuth2 mWeibo = WeiboOAuth2.getInstance();
    ...
    private String getPublicTimeline(WeiboOAuth2 weibo) throws MalformedURLException, IOException,
            WeiboException {
        String url = WeiboOAuth2.SERVER + "statuses/public_timeline.json";
        WeiboParameters bundle = new WeiboParameters();
        bundle.add("source", Weibo.CONSUMER_KEY);
        String rlt = weibo.request(this, url, bundle, "GET", mWeibo.getAccessToken());
        return rlt;
    }

    private String upload(WeiboOAuth2 weibo, String source, String file, String status, String lon,
        ...
        String rlt = "";
        String url = WeiboOAuth2.SERVER + "statuses/upload.json";
        try {
            rlt = weibo
    ...
    private String update(WeiboOAuth2 weibo, String source, String status, String lon, String lat)
        ...
        String rlt = "";
        String url = WeiboOAuth2.SERVER + "statuses/update.json";
