 ...
 */
package com.yh.android.framework.util;
 ...
 * @see com.yh.android.framework.util.support.Base64
 * @author Roy Clarkson
 */
public class Base64Utils {
	 ...
	 * Otherwise {@link com.yh.android.framework.util.support.Base64#encodeBytesToBytes(byte[])}
	 * is used.
	...
	public static byte[] encode(byte[] input) {
		if (froyoOrNewer) {
			...
			return com.yh.android.framework.util.support.Base64.encodeBytesToBytes(input);
		}
	}
	 ...
	 * Otherwise {@link com.yh.android.framework.util.support.Base64#encodeBytes(byte[])}
	 * is used.
	 * @param input the byte array to encode
	...
	public static String encodeToString(byte[] input) {
		if (froyoOrNewer) {
			...
			return com.yh.android.framework.util.support.Base64.encodeBytes(input);
		}
	}
	 ...
	 * Otherwise {@link com.yh.android.framework.util.support.Base64#decode(byte[])}
	 * is used.
	...
	public static byte[] decode(byte[] input) {
		if (froyoOrNewer) {
			...
			try {
				return com.yh.android.framework.util.support.Base64.decode(input);
			} catch (IOException e) {
	 ...
	 * Otherwise {@link com.yh.android.framework.util.support.Base64#decode(String)}
	 * is used.
	...
	public static byte[] decode(String str) {
		if (froyoOrNewer) {
			...
			try {
				return com.yh.android.framework.util.support.Base64.decode(str);
			} catch (IOException e) {
				throw new IllegalArgumentException(e.getLocalizedMessage());
			}
		}
